 ...
 * Use the {@link TourPlanFragment#newInstance} factory method to
...
public class TourPlanFragment extends Fragment {
    ...
    public static TourPlanFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        query = databaseReference.orderByChild("planStatus").equalTo(true);
